...
Pod::Spec.new do |s|
    ...
    s.source_files = 'Sources/Classes/**/*', 'Sources/Headers/*.h', 'Sources/Frameworks/libipay88sdk.xcframework'
    s.vendored_frameworks = 'Sources/Frameworks/libipay88sdk.xcframework'
end
